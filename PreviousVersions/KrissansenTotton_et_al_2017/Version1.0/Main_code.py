...
observ_pH_saved=numpy.loadtxt('geochemical_proxies/obs_pH.txt',delimiter=',') #load proxy pH data from text file
...
observ_CO2=numpy.loadtxt('geochemical_proxies/obs_CO2.txt',delimiter=',') #load proxy CO2 data from text file
...
observ_omega=numpy.loadtxt('geochemical_proxies/obs_omega_calc.txt',delimiter=',') #load proxy CO2 data from text file
...
pylab.fill_between(all_output[4,:,0], confidence_Tdeep[0], confidence_Tdeep[2], color='r', alpha='0.4') #90% confidence model output
observ_Td=numpy.loadtxt('geochemical_proxies/obs_Td.txt',delimiter=',') #load deep ocean temperature data from text file
...
observ_T=numpy.loadtxt('geochemical_proxies/obs_T.txt',delimiter=',')  #load surface temperature data from text file
...
pylab.fill_between(all_output[4,:,0], confidence_Fs[0]/1e12, confidence_Fs[2]/1e12, color='r', alpha='0.4')  #90% confidence model output
...
pylab.fill_between(all_output[4,:,0], confidence_Fd[0]/1e12, confidence_Fd[2]/1e12, color='r', alpha='0.4') #90% confidence model output
